...
const contactMethods = [
  {
    label: 'Email',
    value: 'messaeme@codewithfegig.com',
    href: 'mailto:messaeme@codewithfegig.com',
    icon: Mail,
  },
  {
    label: 'Phone',
      ...
      <section className="bg-background-100 px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-3xl border border-white/10 bg-background-200/55 p-7 sm:p-8">
            ...
            <a
              href="mailto:messaeme@codewithfegig.com?subject=Project%20Inquiry%20for%20FegigTech"
